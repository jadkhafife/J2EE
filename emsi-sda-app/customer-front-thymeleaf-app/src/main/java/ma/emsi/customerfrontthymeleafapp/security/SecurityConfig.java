package ma.emsi.customerfrontthymeleafapp.security;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(ar->ar.requestMatchers("/", "/oauth2/login", "/webjars/**", "/h2-console/**").permitAll())
                .authorizeHttpRequests(ar-> ar.anyRequest().authenticated())
                .oauth2Login(al->al.loginPage("/oauth2/login")
                        .defaultSuccessUrl("/"))
                ...
                .exceptionHandling(eh->eh.accessDeniedPage("/unauthorized"))
                .build();
    }
