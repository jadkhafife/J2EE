...
public interface BanqueService {
    ...
    @RequestWrapper(localName = "conversionMTN", targetNamespace = "http://ws/", className = "proxy.ConversionMTN")
    @ResponseWrapper(localName = "conversionMTNResponse", targetNamespace = "http://ws/", className = "proxy.ConversionMTNResponse")
    @Action(input = "http://ws/BanqueService/conversionMTNRequest", output = "http://ws/BanqueService/conversionMTNResponse")
    public double conversionMTN(
